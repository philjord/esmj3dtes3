	...
	public J3dCELLPersistent makeBGWRLDPersistent(int formId, boolean makePhys)
	{
		...
		if (wrld != null)
		{
			try
			{
				...
				return new J3dCELLPersistent(wrld, this, new Record(cell), new ArrayList<Record>(), makePhys, mediaSources);
			}
			catch (DataFormatException e)
			{
				e.printStackTrace();
	...
	public J3dCELLTemporary makeBGWRLDTemporary(int cellId, int wrldFormId, boolean makePhys)
	{
		...
		try
		{
			...
			if (record != null)
			{
				...
				if (cellChildren != null)
				{
					return new J3dCELLTemporary(this, new Record(record), ESMUtils.getChildren(cellChildren, PluginGroup.CELL_TEMPORARY), makePhys, mediaSources);
				}
			}
		...
		try
		{
			...
			if (record != null)
			{
				...
				if (cellChildren != null)
				{
					...
					return new J3dCELLDistant(this, new Record(record), records, makePhys, mediaSources);
				}
			}
		}
		catch (PluginException e1)
	...
	public J3dCELLPersistent makeBGInteriorCELLPersistent(int cellId, boolean makePhys)
	{
		try
		{
			...
			if (record != null)
			{
				...
				return new J3dCELLPersistent(null, this, new Record(record), ESMUtils.getChildren(cellChildren, PluginGroup.CELL_PERSISTENT), makePhys, mediaSources);
			}
		}
		catch (PluginException e1)
		{
	...
	public J3dCELLDistant makeBGInteriorCELLDistant(int cellId, boolean makePhys)
	{
		...
		try
		{
			...
			if (record != null)
			{
				...
				return new J3dCELLDistant(this, new Record(record), ESMUtils.getChildren(cellChildren, PluginGroup.CELL_DISTANT), makePhys, mediaSources);
			}
		}
		catch (PluginException e1)
		{
